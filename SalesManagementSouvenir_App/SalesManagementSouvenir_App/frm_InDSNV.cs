...
{
    public partial class frm_InDSNV : Form
    {
        public frm_InDSNV()
        {
            InitializeComponent();
        ...
        public void NhanVien()
        {
            try
            {
                ...
                string sql = "select MaNV,HoTenNV,DiaChi,ChucVu,GioiTinh,Email,CMND,SDT,NgaySinh,NgayBDLV,TaiKhoan,MatKhau FROM NHANVIEN";
        ...
        private void frm_InDSNV_Load(object sender, EventArgs e)
        {
            NhanVien();
        }
        int i = 0;
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                ExportExcell(dataGridView1, @"D:\", "ExcelDanhSachNhanVien");
                MessageBox.Show("In danh sách chi tiết nhân viên thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                this.Close();
            }
        }
    }
