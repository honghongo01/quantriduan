...
{
    public partial class frm_InDSHD : Form
    {
        public frm_InDSHD()
        {
            InitializeComponent();
        ...
        public void HoaDon()
        {
            try
            {
                ...
                string sql = "SELECT MaHD,NgayLap,NHANVIEN.HoTenNV,KHACHHANG.TenKhach,TongTien FROM HOADON,KHACHHANG,NHANVIEN WHERE HOADON.MaKH = KHACHHANG.MaKH AND NHANVIEN.MaNV = HOADON.MaNV";
        ...
        private void frm_InDSHD_Load(object sender, EventArgs e)
        {
            HoaDon();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                ExportExcell(dataGridView1, @"D:\", "ExcelDanhSachHoaDon");
                MessageBox.Show("In danh sách hóa đơn thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                this.Close();
